...
Seja {\displaystyle n}n o número total de valores e {\displaystyle x_{i}}x_i cada valor, em que {\displaystyle i=1,\dots ,n}{\displaystyle i=1,\dots ,n}. Média aritmética é a soma dos valores{\displaystyle x_{i}}x_i dividido pelo número total de valores {\displaystyle n}n:
