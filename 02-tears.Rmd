...
```{=latex}
\begin{enumerate}
    \item  Primeiro Quartil divide em $25\%$ em uma amostra ordena os valores inferiores.
    \item Segundo Quartil ou Mediana divide em $50\%$ em uma amostra ordena os valores inferiores.
    \item  Terceiro Quartil divide em $75\%$ em uma amostra ordena os valores superiores.
\end{enumerate}
```
...
Variáveis & C & D   \\ 
  ...
  \hline
\end{tabular}
\caption{Exemplo de tabela de contingência.} 
\end{table}
...
Suponha que tenhamos duas variáveis de uma população, A e B, e queremos relacioná-la com outras duas variáveis C e D . Retirando-se uma amostra aleatória dessa população, uma tabela de contingência conteria as frequências em cada classe da seguinte forma:
